...
<head>
    ...
    <link href="/assets/css/frontend/adsense.css" rel="stylesheet"> <!-- adsense.css import ediliyor -->
    ...
    @endif
	{!! $google_adsense_header !!} <!-- Adsense header script import ediliyor -->
	<script>
		window.liquid = {
			isLandingPage: true
		};
...
<body class="font-golos bg-body-bg text-body group/body">
	...
	{!! $google_adsenses->vertical_ads !!}  <!-- Fixed adsense import ediliyor -->
	</div>
