...
class IndexController extends Controller
{
    public function index(){
		...
		$google_adsense_header = AdsenseController::assetsAdsenseHeader(); //Adsense Header Çağrılması
		$google_adsense_footer = AdsenseController::assetsAdsenseFooter(); //Adsense Footer Çağrılması
		$google_adsenses=AdsenseController::setGoogleAdsenseTypes(); //Adsense Kodlarının Çağrılması
        ...
        return view('index', compact(
            ...
            'who_is_for',
            'generatorsList',
            'google_adsense_header', //View ile paylaşılması
            'google_adsense_footer', //View ile paylaşılması
            'google_adsenses' //View ile paylaşılması
        ));
    }
